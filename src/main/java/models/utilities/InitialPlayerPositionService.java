...
public class InitialPlayerPositionService {
    ...
    public static void placePlayers() {
        ...
        for (String name :
            ...
            Constants.allPlayers.add(new Player(bottomRow, Integer.valueOf(y), name, Constants.initialScore,
                    Constants.playerColors[Integer.valueOf(y)]));
            Constants.playersInitialPos.add(new Player(bottomRow, Integer.valueOf(y), name, Constants.initialScore,
                    Constants.playerColors[Integer.valueOf(y)]));
